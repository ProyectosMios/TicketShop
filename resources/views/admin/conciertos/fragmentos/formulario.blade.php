...
<div class="row mb-3">
    <div class="col">
        <div class="image-wrap">
            @isset ($concierto->imagen)
                <img id="cartel" src="{{ Storage::url($concierto->imagen->direccion) }}" alt="">
            @else
                <img id="cartel" src="{{ Storage::url('imagen/logo.png') }}" alt="">
            @endisset
        </div>
    </div>
    <div class="col">
...
<div class="form-group">
    ...
    {!! Form::number('precio', null, ['step' => 'any']) !!}
    @error("precio")
        <br>
        <small class="text-danger">{{ $message }}</small>
    @enderror
